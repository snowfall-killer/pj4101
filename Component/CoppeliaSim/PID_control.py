...
laser_handle = sim.getObject('/laser_1')
# Set the ball object in the property common tab to be detectable
ball_handle = sim.getObject('/ball_1')
motor_handle = sim.getObject('/motor_1')
...
while True:
    ...
    controlMotor(0.1, 0.05)  # Adjust the time step (dt) as needed
