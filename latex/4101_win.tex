...
%=------------------更改標題內容----------------------=%
\titleformat{\chapter}[hang]{\center\sectionef\fontsize{20pt}{1pt}\bfseries}{第\CJKnumber{\thechapter}章}{1em}{}[]
...
%=-------------作者簡介-----------------=%
	...
	\begin{figure}
	\includegraphics[width=1.25in]{00000}
	\end{figure}
	\end{textblock}}
    ...
    \fontsize{14pt}{0em}\selectfont \makebox[9em][s]{台中市致用高級中學}\\
   ...
   \vspace{2em}
	...
	\begin{figure}
	\includegraphics[width=1.15in]{00000}
    \end{figure}
    \end{textblock}}
...
\hspace*{\fill} \\
\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{經歷}\enspace:\enspace
\fontsize{14pt}{0em}\selectfont \makebox[9em][s]{國立台南高級工業職業學校}\\
\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{\quad}\enspace\enspace
\fontsize{14pt}{0em}\selectfont \makebox[8em][s]{機械科}\\
    \end{textblock}}}
    %\hspace*{\fill} \\
    ...
    \begin{figure}
        \includegraphics[width=1.15in]{00000} %{}內是圖片文件的相對路徑
    \end{figure}
    \end{textblock}}
    {\renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
...
\fontsize{14pt}{0em}\selectfont \makebox[9em][s]{台南市黎明高級中學}\\
    \end{textblock}}}
   % \hspace*{\fill} \\
   \vspace{2em}
...
\hspace*{\fill} \\
\noindent\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{經歷}\enspace:\enspace
\fontsize{14pt}{0em}\selectfont \makebox[9em][s]{國立台北科技大學附屬桃園農工高級中等學校}\\
\fontsize{14pt}{0em}\selectfont \makebox[4em][s]{\quad}\enspace\enspace
\fontsize{14pt}{0em}\selectfont \makebox[8em][s]{動力科}\\
    \end{textblock}}}
\newpage
