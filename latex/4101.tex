...
%=-------------作者簡介-----------------=%
	...
	\begin{figure}
	\includegraphics[width=1.25in]{41023218.png}
	\end{figure}
	\end{textblock}}
   ...
   \vspace{2em}
	...
	\begin{figure}
	\includegraphics[width=1.15in]{41023248.png} 
    \end{figure}
    \end{textblock}}
...
\fontsize{14pt}{0em}\selectfont \makebox[8em][s]{製圖科}\\
    ...
    \begin{figure}
        \includegraphics[width=1.15in]{41023251.png} %{}內是圖片文件的相對路徑
    \end{figure}
    \end{textblock}}
    {\renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
...
\fontsize{14pt}{0em}\selectfont \makebox[9em][s]{新北市立新莊高級中學}\\
   ...
   \vspace{2em}
    ...
    \begin{figure}
        \includegraphics[width=1.15in]{41023254.png} %{}內是圖片文件的相對路徑
    \end{figure}
    \end{textblock}}
    {\renewcommand\baselinestretch{0.99}\selectfont %設定以下行距
